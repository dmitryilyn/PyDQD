...
-- cdm_field_name: DISCHARGED_TO_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_visit_occurrence_discharged_to_source_value
-- thresholdValue: 0
SELECT 
  ...
  CAST('DISCHARGED_TO_SOURCE_VALUE' AS STRING) as cdm_field_name,
