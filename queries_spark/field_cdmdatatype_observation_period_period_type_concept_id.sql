...
-- checkId: field_cdmdatatype_observation_period_period_type_concept_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('PERIOD_TYPE_CONCEPT_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.PERIOD_TYPE_CONCEPT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
