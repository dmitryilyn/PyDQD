...
-- checkId: field_cdmdatatype_specimen_specimen_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('SPECIMEN_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.SPECIMEN_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
