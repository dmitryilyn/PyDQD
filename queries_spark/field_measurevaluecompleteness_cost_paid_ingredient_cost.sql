...
-- cdm_table_name: COST
-- cdm_field_name: PAID_INGREDIENT_COST
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_cost_paid_ingredient_cost
-- thresholdValue: 100
SELECT 
  ...
  CAST('PAID_INGREDIENT_COST' AS STRING) as cdm_field_name,
