...
-- cdm_field_name: SOURCE_VOCABULARY_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- context: Validation
-- checkId: field_isrequired_source_to_concept_map_source_vocabulary_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('SOURCE_VOCABULARY_ID' AS STRING) as cdm_field_name,
