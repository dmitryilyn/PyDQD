...
-- checkId: field_cdmdatatype_condition_occurrence_condition_occurrence_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('CONDITION_OCCURRENCE_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.CONDITION_OCCURRENCE_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
