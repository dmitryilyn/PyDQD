...
-- cdm_field_name: PROVIDER_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_provider_provider_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('PROVIDER_SOURCE_VALUE' AS STRING) as cdm_field_name,
