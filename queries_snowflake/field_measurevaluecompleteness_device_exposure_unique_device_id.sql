...
-- cdm_field_name: UNIQUE_DEVICE_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_device_exposure_unique_device_id
-- thresholdValue: 100
SELECT 
  ...
  CAST('UNIQUE_DEVICE_ID' AS STRING) as cdm_field_name,
