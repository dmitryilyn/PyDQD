...
-- checkId: field_cdmdatatype_cohort_subject_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('SUBJECT_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.SUBJECT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
