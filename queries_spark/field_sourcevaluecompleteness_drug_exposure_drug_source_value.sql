...
-- cdm_field_name: DRUG_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_drug_exposure_drug_source_value
-- thresholdValue: 10
SELECT 
  ...
  CAST('DRUG_SOURCE_VALUE' AS STRING) as cdm_field_name,
