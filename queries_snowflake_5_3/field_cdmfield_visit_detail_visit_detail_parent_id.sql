...
SELECT 
  ...
  ,'A yes or no value indicating if VISIT_DETAIL_PARENT_ID is present in the VISIT_DETAIL table as expected based on the specification.' as check_description
  ...
  ,'' as warning
  ,'' as error
  ,'field_cdmfield_visit_detail_visit_detail_parent_id' as checkid
  ,0 as is_error
  ,0 as not_applicable
