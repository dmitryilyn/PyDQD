...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3038553
-- thresholdValue: 5
SELECT 
  ...
  CAST('3038553' AS INTEGER) as concept_id,
...
conceptId =  3038553
plausibleUnitConceptIds = 9513,9531,9563,9603,9663,32701,44777536,45891027,45891036
**********/
SELECT 
  num_violated_rows, 
	CASE 
