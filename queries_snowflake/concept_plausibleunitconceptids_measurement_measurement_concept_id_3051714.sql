...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3051714
-- thresholdValue: 5
SELECT 
  ...
  CAST('3051714' AS INTEGER) as concept_id,
...
conceptId =  3051714
plausibleUnitConceptIds = 32707,44777663
**********/
SELECT 
  num_violated_rows, 
	CASE 
