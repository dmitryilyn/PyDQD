...
SELECT 
  ...
  ,'The number and percent of records that do not have a standard, valid concept in the ADMITTING_SOURCE_CONCEPT_ID field in the VISIT_OCCURRENCE table.' as check_description
  ...
  ,'' as warning
  ,'' as error
  ,'field_isstandardvalidconcept_visit_occurrence_admitting_source_concept_id' as checkid
  ,0 as is_error
  ,0 as not_applicable
