...
-- cdm_field_name: OBSERVATION_PERIOD_START_DATE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_observation_period_observation_period_start_date
-- thresholdValue: 0
SELECT 
  ...
  CAST('OBSERVATION_PERIOD_START_DATE' AS STRING) as cdm_field_name,
