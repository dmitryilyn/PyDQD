...
-- checkId: field_isforeignkey_episode_event_episode_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('EPISODE_ID' AS STRING) as cdm_field_name,
...
FROM (
	...
	FROM (
		...
		FROM {cdm_schema}.EPISODE_EVENT cdmTable
		  LEFT JOIN {cdm_schema}.EPISODE fkTable
