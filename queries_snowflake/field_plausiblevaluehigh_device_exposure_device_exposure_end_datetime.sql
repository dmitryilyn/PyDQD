...
-- checkId: field_plausiblevaluehigh_device_exposure_device_exposure_end_datetime
-- thresholdValue: 1
SELECT 
...
(
	...
	(
    	...
    	FROM {cdm_schema}.DEVICE_EXPOSURE cdmTable
      	WHERE cast(cdmTable.DEVICE_EXPOSURE_END_DATETIME as date) > cast(DATEADD(dd,1,CURRENT_DATE) as date)
		/*violatedRowsEnd*/
	) violated_rows
) violated_row_count,
(
