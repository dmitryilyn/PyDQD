...
-- cdm_field_name: GENDER_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_provider_gender_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('GENDER_SOURCE_VALUE' AS STRING) as cdm_field_name,
