...
-- cdm_field_name: COHORT_DEFINITION_DESCRIPTION
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_cdmfield_cohort_definition_cohort_definition_description
-- thresholdValue: 0
SELECT 
  ...
  CAST('COHORT_DEFINITION_DESCRIPTION' AS STRING) as cdm_field_name,
