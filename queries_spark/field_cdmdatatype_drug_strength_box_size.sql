...
-- checkId: field_cdmdatatype_drug_strength_box_size
-- thresholdValue: 0
SELECT 
  ...
  CAST('BOX_SIZE' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.BOX_SIZE) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
