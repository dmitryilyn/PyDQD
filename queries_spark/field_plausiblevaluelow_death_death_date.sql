...
-- checkId: field_plausiblevaluelow_death_death_date
-- thresholdValue: 1
SELECT 
  ...
  CAST('DEATH_DATE' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CAST(cdmTable.DEATH_DATE AS DATE) < CAST('1950-01-01' AS DATE)
 /*violatedRowsEnd*/
 ) violated_rows
