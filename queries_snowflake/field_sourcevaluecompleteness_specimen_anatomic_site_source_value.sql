...
-- cdm_field_name: ANATOMIC_SITE_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_specimen_anatomic_site_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('ANATOMIC_SITE_SOURCE_VALUE' AS STRING) as cdm_field_name,
