...
-- cdm_field_name: PLACE_OF_SERVICE_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_care_site_place_of_service_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('PLACE_OF_SERVICE_SOURCE_VALUE' AS STRING) as cdm_field_name,
