...
-- cdm_field_name: COHORT_INITIATION_DATE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_cdmfield_cohort_definition_cohort_initiation_date
-- thresholdValue: 0
SELECT 
  ...
  CAST('COHORT_INITIATION_DATE' AS STRING) as cdm_field_name,
