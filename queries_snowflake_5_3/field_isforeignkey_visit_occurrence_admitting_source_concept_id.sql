...
SELECT 
  ...
  ,'The number and percent of records that have a value in the ADMITTING_SOURCE_CONCEPT_ID field in the VISIT_OCCURRENCE table that does not exist in the CONCEPT table.' as check_description
  ...
  ,'' as warning
  ,'' as error
  ,'field_isforeignkey_visit_occurrence_admitting_source_concept_id' as checkid
  ,0 as is_error
  ,0 as not_applicable
