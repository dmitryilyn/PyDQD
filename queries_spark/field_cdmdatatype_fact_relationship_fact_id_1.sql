...
-- checkId: field_cdmdatatype_fact_relationship_fact_id_1
-- thresholdValue: 0
SELECT 
  ...
  CAST('FACT_ID_1' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.FACT_ID_1) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
