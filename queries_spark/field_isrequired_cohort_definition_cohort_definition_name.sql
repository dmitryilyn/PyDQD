...
-- cdm_field_name: COHORT_DEFINITION_NAME
-- concept_id: NA
-- unit_concept_id: NA
...
-- context: Validation
-- checkId: field_isrequired_cohort_definition_cohort_definition_name
-- thresholdValue: 0
SELECT 
  ...
  CAST('COHORT_DEFINITION_NAME' AS STRING) as cdm_field_name,
