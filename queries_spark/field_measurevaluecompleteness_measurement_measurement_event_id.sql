...
-- cdm_field_name: MEASUREMENT_EVENT_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_measurement_measurement_event_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('MEASUREMENT_EVENT_ID' AS STRING) as cdm_field_name,
