...
SELECT 
  ...
  ,'The number and percent of records that have a value in the DISCHARGE_TO_CONCEPT_ID field in the VISIT_DETAIL table that does not exist in the CONCEPT table.' as check_description
  ...
  ,'' as warning
  ,'' as error
  ,'field_isforeignkey_visit_detail_discharge_to_concept_id' as checkid
  ,0 as is_error
  ,0 as not_applicable
