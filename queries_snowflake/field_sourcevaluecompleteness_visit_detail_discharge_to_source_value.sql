...
-- checkId: field_sourcevaluecompleteness_visit_detail_discharge_to_source_value
-- thresholdValue: 100
SELECT 
  ...
  '' as warning,
  '' as error,
  'field_sourcevaluecompleteness_visit_detail_discharge_to_source_value' as checkid,
  0 as is_error,
  0 as not_applicable,
