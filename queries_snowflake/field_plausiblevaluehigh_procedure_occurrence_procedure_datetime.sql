...
-- checkId: field_plausiblevaluehigh_procedure_occurrence_procedure_datetime
-- thresholdValue: 1
SELECT 
...
(
	...
	(
    	...
    	FROM {cdm_schema}.PROCEDURE_OCCURRENCE cdmTable
      	WHERE cast(cdmTable.PROCEDURE_DATETIME as date) > cast(DATEADD(dd,1,CURRENT_DATE) as date)
		/*violatedRowsEnd*/
	) violated_rows
) violated_row_count,
(
