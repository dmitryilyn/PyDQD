...
SELECT 
  ...
  ,'The number and percent of distinct source values in the ADMITTING_SOURCE_VALUE field of the VISIT_OCCURRENCE table mapped to 0.' as check_description
  ,'VISIT_OCCURRENCE' as cdm_table_name
  ,'ADMITTING_SOURCE_VALUE' as cdm_field_name
  ,'NA' as concept_id
