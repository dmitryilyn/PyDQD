...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_40771922
-- thresholdValue: 5
SELECT 
  ...
  CAST('40771922' AS INTEGER) as concept_id,
...
conceptId = 40771922
plausibleUnitConceptIds = 8698,8795,8857,8930,32700,44777523,44777603,44777613,44777614,44777664
**********/
SELECT 
  num_violated_rows, 
	CASE 
