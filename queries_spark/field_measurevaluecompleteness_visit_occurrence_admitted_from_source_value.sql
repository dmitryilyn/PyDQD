...
-- cdm_field_name: ADMITTED_FROM_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_visit_occurrence_admitted_from_source_value
-- thresholdValue: 0
SELECT 
  ...
  CAST('ADMITTED_FROM_SOURCE_VALUE' AS STRING) as cdm_field_name,
