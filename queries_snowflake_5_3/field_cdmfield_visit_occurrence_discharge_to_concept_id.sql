...
SELECT 
  ...
  ,'A yes or no value indicating if DISCHARGE_TO_CONCEPT_ID is present in the VISIT_OCCURRENCE table as expected based on the specification.' as check_description
