...
-- cdm_field_name: DISCHARGE_TO_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_visit_occurrence_discharge_to_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('sourceValueCompleteness' AS STRING) as check_name,
  ...
  CAST('DISCHARGE_TO_SOURCE_VALUE' AS STRING) as cdm_field_name,
  CAST(NULL AS INTEGER) as concept_id,
  CAST(NULL AS INTEGER) as unit_concept_id,
  CAST('field_source_value_completeness.sql' AS STRING) as sql_file,
  CAST('Completeness' AS STRING) as category,
  CAST('' AS STRING) as subcategory,
  CAST('Verification' AS STRING) context,
  '' as warning,
  '' as error,
  'field_sourcevaluecompleteness_visit_occurrence_discharge_to_source_value' as checkid,
  0 as is_error,
  0 as not_applicable,
