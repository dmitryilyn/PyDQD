...
-- checkId: field_cdmdatatype_note_nlp_note_nlp_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('NOTE_NLP_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.NOTE_NLP_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
