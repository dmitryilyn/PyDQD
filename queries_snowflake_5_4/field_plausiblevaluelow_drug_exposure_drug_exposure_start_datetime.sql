...
SELECT 
  ...
  ,'The number and percent of records with a value in the DRUG_EXPOSURE_START_DATETIME field of the DRUG_EXPOSURE table less than ''1950-01-01''.' as check_description
