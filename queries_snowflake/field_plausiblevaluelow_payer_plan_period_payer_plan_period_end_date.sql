...
-- cdm_field_name: PAYER_PLAN_PERIOD_END_DATE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_plausiblevaluelow_payer_plan_period_payer_plan_period_end_date
-- thresholdValue: 1
SELECT 
  ...
  CAST('PAYER_PLAN_PERIOD_END_DATE' AS STRING) as cdm_field_name,
...
FROM (
    ...
    WHERE CAST(cdmTable.PAYER_PLAN_PERIOD_END_DATE AS DATE) < CAST('1950-01-01' AS DATE)
		/*violatedRowsEnd*/
	) violated_rows
) violated_row_count,
(
