...
-- checkId: field_cdmdatatype_provider_year_of_birth
-- thresholdValue: 0
SELECT 
  ...
  CAST('YEAR_OF_BIRTH' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.YEAR_OF_BIRTH) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
