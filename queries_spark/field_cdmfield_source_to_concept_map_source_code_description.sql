...
-- cdm_field_name: SOURCE_CODE_DESCRIPTION
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_cdmfield_source_to_concept_map_source_code_description
-- thresholdValue: 0
SELECT 
  ...
  CAST('SOURCE_CODE_DESCRIPTION' AS STRING) as cdm_field_name,
