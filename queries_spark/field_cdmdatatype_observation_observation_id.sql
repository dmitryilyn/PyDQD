...
-- checkId: field_cdmdatatype_observation_observation_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('OBSERVATION_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.OBSERVATION_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
