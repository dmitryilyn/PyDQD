...
-- cdm_field_name: VISIT_DETAIL_END_DATE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_visit_detail_visit_detail_end_date
-- thresholdValue: 0
SELECT 
  ...
  CAST('VISIT_DETAIL_END_DATE' AS STRING) as cdm_field_name,
