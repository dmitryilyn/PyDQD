...
-- cdm_table_name: COST
-- cdm_field_name: PAID_PATIENT_DEDUCTIBLE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_cost_paid_patient_deductible
-- thresholdValue: 100
SELECT 
  ...
  CAST('PAID_PATIENT_DEDUCTIBLE' AS STRING) as cdm_field_name,
