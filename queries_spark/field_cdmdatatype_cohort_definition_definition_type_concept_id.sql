...
-- checkId: field_cdmdatatype_cohort_definition_definition_type_concept_id
-- thresholdValue: 0
SELECT 
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.DEFINITION_TYPE_CONCEPT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
