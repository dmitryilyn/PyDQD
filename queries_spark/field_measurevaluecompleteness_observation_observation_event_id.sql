...
-- cdm_field_name: OBSERVATION_EVENT_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_observation_observation_event_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('OBSERVATION_EVENT_ID' AS STRING) as cdm_field_name,
