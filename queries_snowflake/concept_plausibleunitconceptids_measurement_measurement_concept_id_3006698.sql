...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3006698
-- thresholdValue: 5
SELECT 
  ...
  CAST('3006698' AS INTEGER) as concept_id,
...
conceptId =  3006698
plausibleUnitConceptIds = 9211,9212,9481,9484,9518,9636
**********/
SELECT 
  num_violated_rows, 
	CASE 
