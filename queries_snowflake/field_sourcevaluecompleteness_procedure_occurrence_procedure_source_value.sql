...
-- cdm_field_name: PROCEDURE_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_procedure_occurrence_procedure_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('PROCEDURE_SOURCE_VALUE' AS STRING) as cdm_field_name,
