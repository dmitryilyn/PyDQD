...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_46235152
-- thresholdValue: 5
SELECT 
  ...
  CAST('46235152' AS INTEGER) as concept_id,
...
conceptId = 46235152
plausibleUnitConceptIds = 9289,9289,9523,9523,586323,586323
**********/
SELECT 
  num_violated_rows, 
	CASE 
