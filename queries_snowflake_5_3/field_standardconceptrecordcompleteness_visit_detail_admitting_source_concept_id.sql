...
SELECT 
  ...
  ,'The number and percent of records with a value of 0 in the standard concept field ADMITTING_SOURCE_CONCEPT_ID in the VISIT_DETAIL table.' as check_description
  ...
  ,'' as warning
  ,'' as error
  ,'field_standardconceptrecordcompleteness_visit_detail_admitting_source_concept_id' as checkid
  ,0 as is_error
  ,0 as not_applicable
