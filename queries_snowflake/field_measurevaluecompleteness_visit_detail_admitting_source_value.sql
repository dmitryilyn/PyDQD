...
-- checkId: field_measurevaluecompleteness_visit_detail_admitting_source_value
-- thresholdValue: 100
SELECT 
  ...
  '' as warning,
  '' as error,
  'field_measurevaluecompleteness_visit_detail_admitting_source_value' as checkid,
  0 as is_error,
  0 as not_applicable,
