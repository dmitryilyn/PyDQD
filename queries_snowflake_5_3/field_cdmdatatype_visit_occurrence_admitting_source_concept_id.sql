...
SELECT 
  ...
  ,'A yes or no value indicating if the ADMITTING_SOURCE_CONCEPT_ID in the VISIT_OCCURRENCE is the expected data type based on the specification.' as check_description
...
(
	...
	(
		...
		WHERE IS_REAL(TRY_TO_NUMERIC(abs(cdmTable.ADMITTING_SOURCE_CONCEPT_ID))) = 0 
