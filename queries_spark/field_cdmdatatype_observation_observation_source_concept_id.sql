...
-- checkId: field_cdmdatatype_observation_observation_source_concept_id
-- thresholdValue: 0
SELECT 
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.OBSERVATION_SOURCE_CONCEPT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
