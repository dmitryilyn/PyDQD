...
-- cdm_field_name: OBSERVATION_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_observation_observation_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('OBSERVATION_SOURCE_VALUE' AS STRING) as cdm_field_name,
