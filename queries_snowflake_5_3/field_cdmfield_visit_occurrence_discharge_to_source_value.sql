...
SELECT 
  ...
  ,'A yes or no value indicating if DISCHARGE_TO_SOURCE_VALUE is present in the VISIT_OCCURRENCE table as expected based on the specification.' as check_description
  ...
  ,'' as warning
  ,'' as error
  ,'field_cdmfield_visit_occurrence_discharge_to_source_value' as checkid
  ,0 as is_error
  ,0 as not_applicable
