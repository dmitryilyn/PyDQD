...
-- cdm_field_name: DISEASE_STATUS_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_specimen_disease_status_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('DISEASE_STATUS_SOURCE_VALUE' AS STRING) as cdm_field_name,
