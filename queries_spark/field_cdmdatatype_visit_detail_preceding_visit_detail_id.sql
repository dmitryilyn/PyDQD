...
-- cdm_field_name: PRECEDING_VISIT_DETAIL_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_cdmdatatype_visit_detail_preceding_visit_detail_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('PRECEDING_VISIT_DETAIL_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.PRECEDING_VISIT_DETAIL_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
