...
-- checkId: field_cdmdatatype_metadata_metadata_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('METADATA_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.METADATA_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
