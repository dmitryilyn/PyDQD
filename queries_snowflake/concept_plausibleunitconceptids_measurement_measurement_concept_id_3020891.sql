...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3020891
-- thresholdValue: 5
SELECT 
  ...
  CAST('3020891' AS INTEGER) as concept_id,
...
conceptId =  3020891
plausibleUnitConceptIds = 9289,9523,586323
**********/
SELECT 
  num_violated_rows, 
	CASE 
