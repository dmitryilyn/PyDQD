...
-- cdm_field_name: DISCHARGE_TO_CONCEPT_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_cdmdatatype_visit_occurrence_discharge_to_concept_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('DISCHARGE_TO_CONCEPT_ID' AS STRING) as cdm_field_name,
...
(
	...
	(
		...
		WHERE IS_REAL(TRY_TO_NUMERIC(abs(cdmTable.DISCHARGE_TO_CONCEPT_ID))) = 0 
