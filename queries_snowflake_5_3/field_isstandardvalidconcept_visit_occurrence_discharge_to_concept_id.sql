...
SELECT 
  ...
  ,'The number and percent of records that do not have a standard, valid concept in the DISCHARGE_TO_CONCEPT_ID field in the VISIT_OCCURRENCE table.' as check_description
