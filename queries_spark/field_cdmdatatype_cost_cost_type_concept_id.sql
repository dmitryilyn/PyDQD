...
-- cdm_table_name: COST
-- cdm_field_name: COST_TYPE_CONCEPT_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_cdmdatatype_cost_cost_type_concept_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('COST_TYPE_CONCEPT_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.COST_TYPE_CONCEPT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
