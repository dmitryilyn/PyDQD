...
-- cdm_field_name: ADMITTING_SOURCE_CONCEPT_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_cdmdatatype_visit_occurrence_admitting_source_concept_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('ADMITTING_SOURCE_CONCEPT_ID' AS STRING) as cdm_field_name,
