...
-- cdm_field_name: VISIT_DETAIL_SOURCE_CONCEPT_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourceconceptrecordcompleteness_visit_detail_visit_detail_source_concept_id
-- thresholdValue: 100
SELECT 
  ...
  CAST('VISIT_DETAIL_SOURCE_CONCEPT_ID' AS STRING) as cdm_field_name,
