...
-- cdm_field_name: SPONSOR_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_payer_plan_period_sponsor_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('SPONSOR_SOURCE_VALUE' AS STRING) as cdm_field_name,
