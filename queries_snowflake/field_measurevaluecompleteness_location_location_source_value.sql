...
-- cdm_field_name: LOCATION_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_location_location_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('LOCATION_SOURCE_VALUE' AS STRING) as cdm_field_name,
