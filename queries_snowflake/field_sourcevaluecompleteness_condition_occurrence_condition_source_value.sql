...
-- cdm_field_name: CONDITION_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_condition_occurrence_condition_source_value
-- thresholdValue: 10
SELECT 
  ...
  CAST('CONDITION_SOURCE_VALUE' AS STRING) as cdm_field_name,
