...
-- checkId: field_measurevaluecompleteness_visit_detail_discharge_to_concept_id
-- thresholdValue: 100
SELECT 
  ...
  '' as warning,
  '' as error,
  'field_measurevaluecompleteness_visit_detail_discharge_to_concept_id' as checkid,
  0 as is_error,
  0 as not_applicable,
