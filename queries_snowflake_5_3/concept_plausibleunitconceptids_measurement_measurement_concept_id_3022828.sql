...
SELECT 
  ...
  ,'The number and percent of records for a given CONCEPT_ID  3022828 (MOTHER''S RACE) with implausible units (i.e., UNIT_CONCEPT_ID NOT IN  (NA)).' as check_description
