...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3015183
-- thresholdValue: 5
SELECT 
  ...
  CAST('3015183' AS INTEGER) as concept_id,
...
conceptId =  3015183
plausibleUnitConceptIds = 8752,9272,9340,9341,32710,32738,44777522,44777606
**********/
SELECT 
  num_violated_rows, 
	CASE 
