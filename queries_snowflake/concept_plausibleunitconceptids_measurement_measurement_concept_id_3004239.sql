...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3004239
-- thresholdValue: 5
SELECT 
  ...
  CAST('3004239' AS INTEGER) as concept_id,
...
conceptId =  3004239
plausibleUnitConceptIds = 8774,8791,8807,8906,8908,8909,9502,9646,44777534,44777593,44777594,44777610,44777611,44777624,44777645,45891021,45891022,45891023
**********/
SELECT 
  num_violated_rows, 
	CASE 
