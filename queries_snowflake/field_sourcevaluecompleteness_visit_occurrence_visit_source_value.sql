...
-- cdm_field_name: VISIT_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_visit_occurrence_visit_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('VISIT_SOURCE_VALUE' AS STRING) as cdm_field_name,
