...
-- cdm_field_name: VOCABULARY_VERSION
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_cdm_source_vocabulary_version
-- thresholdValue: 100
SELECT 
  ...
  CAST('VOCABULARY_VERSION' AS STRING) as cdm_field_name,
