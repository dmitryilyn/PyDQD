...
-- cdm_field_name: SPECIALTY_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_provider_specialty_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('SPECIALTY_SOURCE_VALUE' AS STRING) as cdm_field_name,
