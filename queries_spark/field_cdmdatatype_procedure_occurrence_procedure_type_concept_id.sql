...
-- cdm_field_name: PROCEDURE_TYPE_CONCEPT_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_cdmdatatype_procedure_occurrence_procedure_type_concept_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('PROCEDURE_TYPE_CONCEPT_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.PROCEDURE_TYPE_CONCEPT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
