...
-- checkId: field_cdmdatatype_dose_era_dose_era_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('DOSE_ERA_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.DOSE_ERA_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
