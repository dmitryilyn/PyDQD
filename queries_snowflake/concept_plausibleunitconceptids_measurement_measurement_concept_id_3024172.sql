...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3024172
-- thresholdValue: 5
SELECT 
  ...
  CAST('3024172' AS INTEGER) as concept_id,
