...
-- checkId: field_cdmdatatype_care_site_location_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('LOCATION_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.LOCATION_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
