...
SELECT 
  ...
  ,'A yes or no value indicating if "OFFSET" is present in the NOTE_NLP table as expected based on the specification.' as check_description
  ,'NOTE_NLP' as cdm_table_name
  ,'"OFFSET"' as cdm_field_name
  ,'NA' as concept_id
  ...
  ,'' as warning
  ,'' as error
  ,'field_cdmfield_note_nlp_"offset"' as checkid
  ,0 as is_error
  ,0 as not_applicable
