...
SELECT 
  ...
  ,'The number and percent of records with a value in the VISIT_START_DATETIME field of the VISIT_OCCURRENCE table less than ''1950-01-01''.' as check_description
