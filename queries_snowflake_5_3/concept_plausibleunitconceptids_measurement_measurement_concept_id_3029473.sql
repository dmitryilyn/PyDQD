...
SELECT 
  ...
  ,'The number and percent of records for a given CONCEPT_ID  3029473 (PH OF ARTERIAL BLOOD ADJUSTED TO PATIENT''S ACTUAL TEMPERATURE) with implausible units (i.e., UNIT_CONCEPT_ID NOT IN  (8482,8518)).' as check_description
...
conceptId =  3029473
plausibleUnitConceptIds = 8482,8518
**********/
SELECT 
  num_violated_rows, 
	CASE 
