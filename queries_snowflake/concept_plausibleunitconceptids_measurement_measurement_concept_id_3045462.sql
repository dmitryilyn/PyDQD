...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3045462
-- thresholdValue: 5
SELECT 
  ...
  CAST('3045462' AS INTEGER) as concept_id,
...
conceptId =  3045462
plausibleUnitConceptIds = 9533,32408,32702,44777595,44777612
**********/
SELECT 
  num_violated_rows, 
	CASE 
