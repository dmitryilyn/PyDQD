...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3010696
-- thresholdValue: 5
SELECT 
  ...
  CAST('3010696' AS INTEGER) as concept_id,
...
conceptId =  3010696
plausibleUnitConceptIds = 8993,9527,9672,44777629
**********/
SELECT 
  num_violated_rows, 
	CASE 
