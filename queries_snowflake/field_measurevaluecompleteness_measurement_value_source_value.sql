...
-- cdm_field_name: VALUE_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_measurement_value_source_value
-- thresholdValue: 0
SELECT 
  ...
  CAST('VALUE_SOURCE_VALUE' AS STRING) as cdm_field_name,
