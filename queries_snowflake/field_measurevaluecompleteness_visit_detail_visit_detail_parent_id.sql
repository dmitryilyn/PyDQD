...
-- cdm_field_name: VISIT_DETAIL_PARENT_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_visit_detail_visit_detail_parent_id
-- thresholdValue: 100
SELECT 
  ...
  CAST('VISIT_DETAIL_PARENT_ID' AS STRING) as cdm_field_name,
  ...
  '' as warning,
  '' as error,
  'field_measurevaluecompleteness_visit_detail_visit_detail_parent_id' as checkid,
  0 as is_error,
  0 as not_applicable,
