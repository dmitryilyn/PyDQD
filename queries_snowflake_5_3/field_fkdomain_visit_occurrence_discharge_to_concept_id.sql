...
SELECT 
  ...
  ,'The number and percent of records that have a value in the DISCHARGE_TO_CONCEPT_ID field in the VISIT_OCCURRENCE table that do not conform to the VISIT domain.' as check_description
  ...
  ,'' as warning
  ,'' as error
  ,'field_fkdomain_visit_occurrence_discharge_to_concept_id' as checkid
  ,0 as is_error
  ,0 as not_applicable
