...
-- cdm_field_name: SPECIMEN_SOURCE_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_specimen_specimen_source_id
-- thresholdValue: 100
SELECT 
  ...
  CAST('SPECIMEN_SOURCE_ID' AS STRING) as cdm_field_name,
