...
-- cdm_field_name: CONDITION_OCCURRENCE_COUNT
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_cdmdatatype_condition_era_condition_occurrence_count
-- thresholdValue: 0
SELECT 
  ...
  CAST('CONDITION_OCCURRENCE_COUNT' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.CONDITION_OCCURRENCE_COUNT) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
