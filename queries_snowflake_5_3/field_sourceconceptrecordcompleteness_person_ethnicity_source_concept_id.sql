...
SELECT 
  ...
  ,'The number and percent of records with a value of 0 in the source concept field ETHNICITY_SOURCE_CONCEPT_ID in the PERSON table.' as check_description
  ...
  ,'' as warning
  ,'' as error
  ,'field_sourceconceptrecordcompleteness_person_ethnicity_source_concept_id' as checkid
  ,0 as is_error
  ,0 as not_applicable
