...
-- checkId: field_cdmdatatype_drug_exposure_days_supply
-- thresholdValue: 0
SELECT 
  ...
  CAST('DAYS_SUPPLY' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.DAYS_SUPPLY) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
