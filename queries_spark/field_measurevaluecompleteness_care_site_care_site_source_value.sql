...
-- cdm_field_name: CARE_SITE_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_care_site_care_site_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('CARE_SITE_SOURCE_VALUE' AS STRING) as cdm_field_name,
