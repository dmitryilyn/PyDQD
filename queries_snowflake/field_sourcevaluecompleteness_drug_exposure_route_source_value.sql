...
-- cdm_field_name: ROUTE_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_drug_exposure_route_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('ROUTE_SOURCE_VALUE' AS STRING) as cdm_field_name,
