...
SELECT 
  ...
  ,'The number and percent of records with a value in the CDM_RELEASE_DATE field of the CDM_SOURCE table less than ''2000-01-01''.' as check_description
...
FROM (
    ...
    WHERE CAST(cdmTable.CDM_RELEASE_DATE AS DATE) < CAST('2000-01-01' AS DATE)
		/*violatedRowsEnd*/
	) violated_rows
) violated_row_count,
(
