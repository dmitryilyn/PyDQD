...
-- checkId: field_cdmdatatype_drug_era_gap_days
-- thresholdValue: 0
SELECT 
  ...
  CAST('GAP_DAYS' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.GAP_DAYS) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
