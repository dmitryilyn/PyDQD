...
-- cdm_field_name: ETHNICITY_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_person_ethnicity_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('ETHNICITY_SOURCE_VALUE' AS STRING) as cdm_field_name,
