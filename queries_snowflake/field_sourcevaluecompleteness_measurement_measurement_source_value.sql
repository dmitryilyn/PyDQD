...
-- cdm_field_name: MEASUREMENT_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_measurement_measurement_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('MEASUREMENT_SOURCE_VALUE' AS STRING) as cdm_field_name,
