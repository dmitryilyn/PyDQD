...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3007808
-- thresholdValue: 5
SELECT 
  ...
  CAST('3007808' AS INTEGER) as concept_id,
...
conceptId =  3007808
plausibleUnitConceptIds = 8992,9020
**********/
SELECT 
  num_violated_rows, 
	CASE 
