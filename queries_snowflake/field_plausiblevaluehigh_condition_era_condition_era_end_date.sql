...
-- checkId: field_plausiblevaluehigh_condition_era_condition_era_end_date
-- thresholdValue: 1
SELECT 
...
(
	...
	(
    	...
    	FROM {cdm_schema}.CONDITION_ERA cdmTable
      	WHERE cast(cdmTable.CONDITION_ERA_END_DATE as date) > cast(DATEADD(dd,1,CURRENT_DATE) as date)
		/*violatedRowsEnd*/
	) violated_rows
) violated_row_count,
(
