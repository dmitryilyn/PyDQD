...
-- checkId: field_cdmdatatype_procedure_occurrence_visit_detail_id
-- thresholdValue: 0
SELECT 
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.VISIT_DETAIL_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
