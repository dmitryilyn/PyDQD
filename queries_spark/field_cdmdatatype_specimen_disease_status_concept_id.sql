...
-- checkId: field_cdmdatatype_specimen_disease_status_concept_id
-- thresholdValue: 0
SELECT 
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.DISEASE_STATUS_CONCEPT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
