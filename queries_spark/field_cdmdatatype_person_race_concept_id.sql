...
-- checkId: field_cdmdatatype_person_race_concept_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('RACE_CONCEPT_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.RACE_CONCEPT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
