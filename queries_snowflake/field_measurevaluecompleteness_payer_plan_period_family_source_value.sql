...
-- cdm_field_name: FAMILY_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_payer_plan_period_family_source_value
-- thresholdValue: 0
SELECT 
  ...
  CAST('FAMILY_SOURCE_VALUE' AS STRING) as cdm_field_name,
