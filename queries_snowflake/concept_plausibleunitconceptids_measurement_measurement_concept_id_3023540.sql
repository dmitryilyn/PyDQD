...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3023540
-- thresholdValue: 5
SELECT 
  ...
  CAST('3023540' AS INTEGER) as concept_id,
