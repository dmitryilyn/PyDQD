...
-- cdm_table_name: COST
-- cdm_field_name: REVENUE_CODE_CONCEPT_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_cdmdatatype_cost_revenue_code_concept_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('REVENUE_CODE_CONCEPT_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.REVENUE_CODE_CONCEPT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
