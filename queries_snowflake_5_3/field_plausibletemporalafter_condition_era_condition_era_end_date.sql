...
SELECT 
  ...
  ,'The number and percent of records with a value in the CONDITION_ERA_END_DATE field of the CONDITION_ERA that occurs prior to the date in the BIRTH_DATETIME field of the PERSON table.' as check_description
...
(
	...
	(
    	...
    	FROM {cdm_schema}.CONDITION_ERA cdmTable
				JOIN {cdm_schema}.PERSON plausibleTable 
