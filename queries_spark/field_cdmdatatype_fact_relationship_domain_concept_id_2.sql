...
-- cdm_field_name: DOMAIN_CONCEPT_ID_2
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_cdmdatatype_fact_relationship_domain_concept_id_2
-- thresholdValue: 0
SELECT 
  ...
  CAST('DOMAIN_CONCEPT_ID_2' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.DOMAIN_CONCEPT_ID_2) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
