...
-- cdm_field_name: VISIT_TYPE_CONCEPT_ID
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_standardconceptrecordcompleteness_visit_occurrence_visit_type_concept_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('VISIT_TYPE_CONCEPT_ID' AS STRING) as cdm_field_name,
