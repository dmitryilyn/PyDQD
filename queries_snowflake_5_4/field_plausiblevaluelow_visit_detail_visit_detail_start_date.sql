...
SELECT 
  ...
  ,'The number and percent of records with a value in the VISIT_DETAIL_START_DATE field of the VISIT_DETAIL table less than ''1950-01-01''.' as check_description
