...
-- cdm_field_name: SOURCE_DESCRIPTION
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_cdm_source_source_description
-- thresholdValue: 100
SELECT 
  ...
  CAST('SOURCE_DESCRIPTION' AS STRING) as cdm_field_name,
