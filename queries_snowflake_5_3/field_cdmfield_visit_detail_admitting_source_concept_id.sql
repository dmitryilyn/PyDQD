...
SELECT 
  ...
  ,'A yes or no value indicating if ADMITTING_SOURCE_CONCEPT_ID is present in the VISIT_DETAIL table as expected based on the specification.' as check_description
  ...
  ,'' as warning
  ,'' as error
  ,'field_cdmfield_visit_detail_admitting_source_concept_id' as checkid
  ,0 as is_error
  ,0 as not_applicable
