...
-- cdm_field_name: EPISODE_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_episode_episode_source_value
-- thresholdValue: 0
SELECT 
  ...
  CAST('EPISODE_SOURCE_VALUE' AS STRING) as cdm_field_name,
