...
-- cdm_field_name: ADMITTING_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_visit_occurrence_admitting_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('ADMITTING_SOURCE_VALUE' AS STRING) as cdm_field_name,
  ...
  '' as warning,
  '' as error,
  'field_sourcevaluecompleteness_visit_occurrence_admitting_source_value' as checkid,
  0 as is_error,
  0 as not_applicable,
