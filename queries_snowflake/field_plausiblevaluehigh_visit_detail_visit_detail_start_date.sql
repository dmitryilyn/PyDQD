...
-- checkId: field_plausiblevaluehigh_visit_detail_visit_detail_start_date
-- thresholdValue: 1
SELECT 
...
(
	...
	(
    	...
    	FROM {cdm_schema}.VISIT_DETAIL cdmTable
      	WHERE cast(cdmTable.VISIT_DETAIL_START_DATE as date) > cast(DATEADD(dd,1,CURRENT_DATE) as date)
		/*violatedRowsEnd*/
	) violated_rows
) violated_row_count,
(
