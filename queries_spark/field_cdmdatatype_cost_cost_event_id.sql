...
-- checkId: field_cdmdatatype_cost_cost_event_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('COST_EVENT_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.COST_EVENT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
