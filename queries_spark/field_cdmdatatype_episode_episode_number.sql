...
-- checkId: field_cdmdatatype_episode_episode_number
-- thresholdValue: 0
SELECT 
  ...
  CAST('EPISODE_NUMBER' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.EPISODE_NUMBER) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
