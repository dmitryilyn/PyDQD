...
-- cdm_field_name: DEVICE_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_device_exposure_device_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('DEVICE_SOURCE_VALUE' AS STRING) as cdm_field_name,
