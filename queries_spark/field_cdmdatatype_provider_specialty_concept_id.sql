...
-- checkId: field_cdmdatatype_provider_specialty_concept_id
-- thresholdValue: 0
SELECT 
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.SPECIALTY_CONCEPT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
