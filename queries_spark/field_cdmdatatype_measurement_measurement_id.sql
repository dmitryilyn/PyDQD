...
-- checkId: field_cdmdatatype_measurement_measurement_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('MEASUREMENT_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.MEASUREMENT_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
