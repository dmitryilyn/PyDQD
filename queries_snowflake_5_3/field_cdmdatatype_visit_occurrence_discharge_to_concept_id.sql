...
SELECT 
  ...
  ,'A yes or no value indicating if the DISCHARGE_TO_CONCEPT_ID in the VISIT_OCCURRENCE is the expected data type based on the specification.' as check_description
