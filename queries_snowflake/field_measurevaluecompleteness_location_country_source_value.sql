...
-- cdm_field_name: COUNTRY_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_location_country_source_value
-- thresholdValue: 0
SELECT 
  ...
  CAST('COUNTRY_SOURCE_VALUE' AS STRING) as cdm_field_name,
