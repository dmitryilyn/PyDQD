...
SELECT 
  ...
  ,'The number and percent of records with a value in the EPISODE_END_DATE field of the EPISODE table less than ''1950-01-01''.' as check_description
...
FROM (
    ...
    WHERE CAST(cdmTable.EPISODE_END_DATE AS DATE) < CAST('1950-01-01' AS DATE)
		/*violatedRowsEnd*/
	) violated_rows
) violated_row_count,
(
