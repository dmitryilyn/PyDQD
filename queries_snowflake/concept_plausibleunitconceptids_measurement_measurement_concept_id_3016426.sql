...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3016426
-- thresholdValue: 5
SELECT 
  ...
  CAST('3016426' AS INTEGER) as concept_id,
