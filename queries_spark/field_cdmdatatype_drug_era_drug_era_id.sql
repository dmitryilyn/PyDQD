...
-- checkId: field_cdmdatatype_drug_era_drug_era_id
-- thresholdValue: 0
SELECT 
  ...
  CAST('DRUG_ERA_ID' AS STRING) as cdm_field_name,
...
FROM (
 ...
 WHERE CASE WHEN CAST(abs(cdmTable.DRUG_ERA_ID) AS DOUBLE) IS NOT NULL THEN 1 ELSE 0 END = 0 
