...
-- checkId: field_sourceconceptrecordcompleteness_person_gender_source_concept_id
-- thresholdValue: 100
SELECT 
  ...
  '' as warning,
  '' as error,
  'field_sourceconceptrecordcompleteness_person_gender_source_concept_id' as checkid,
  0 as is_error,
  0 as not_applicable,
