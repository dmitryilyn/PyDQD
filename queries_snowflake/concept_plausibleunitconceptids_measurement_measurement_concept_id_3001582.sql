...
-- checkId: concept_plausibleunitconceptids_measurement_measurement_concept_id_3001582
-- thresholdValue: 5
SELECT 
  ...
  CAST('3001582' AS INTEGER) as concept_id,
...
conceptId =  3001582
plausibleUnitConceptIds = 8723,9017,9072,9074
**********/
SELECT 
  num_violated_rows, 
	CASE 
