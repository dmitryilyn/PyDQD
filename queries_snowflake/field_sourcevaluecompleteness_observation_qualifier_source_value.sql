...
-- cdm_field_name: QUALIFIER_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_sourcevaluecompleteness_observation_qualifier_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('QUALIFIER_SOURCE_VALUE' AS STRING) as cdm_field_name,
