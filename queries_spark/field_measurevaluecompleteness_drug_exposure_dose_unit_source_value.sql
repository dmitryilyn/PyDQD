...
-- cdm_field_name: DOSE_UNIT_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_drug_exposure_dose_unit_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('DOSE_UNIT_SOURCE_VALUE' AS STRING) as cdm_field_name,
