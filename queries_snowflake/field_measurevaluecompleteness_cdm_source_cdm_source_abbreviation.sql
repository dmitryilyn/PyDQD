...
-- cdm_field_name: CDM_SOURCE_ABBREVIATION
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_cdm_source_cdm_source_abbreviation
-- thresholdValue: 100
SELECT 
  ...
  CAST('CDM_SOURCE_ABBREVIATION' AS STRING) as cdm_field_name,
