...
-- cdm_table_name: COST
-- cdm_field_name: REVENUE_CODE_SOURCE_VALUE
-- concept_id: NA
-- unit_concept_id: NA
...
-- checkId: field_measurevaluecompleteness_cost_revenue_code_source_value
-- thresholdValue: 100
SELECT 
  ...
  CAST('REVENUE_CODE_SOURCE_VALUE' AS STRING) as cdm_field_name,
